  ...
  Widget build(BuildContext context) {
    return Consumer<NavigationProvider>(
      builder: (context, navigationProvider, child) {
        final double screenHeight = MediaQuery.of(context).size.height; // Get the screen height using MediaQuery
        ...
        return Scaffold(
              ...
              builder: (context, constraints) {
                return Column(
                  children: [
                    Container(
                      color: greycolor,
                      height: constraints.maxHeight * 0.12, // 12% of the screen height
                      padding: EdgeInsets.symmetric(
                        vertical: constraints.maxHeight * 0.03, // 3% for vertical padding
                        horizontal: constraints.maxWidth * 0.02, // 2% for horizontal padding
                      ),
          ...
          bottomNavigationBar: Container(
            height: screenHeight * 0.11, // Use 11% of the total screen height for bottom navigation
